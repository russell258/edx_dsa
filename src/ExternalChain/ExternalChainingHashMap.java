...
public class ExternalChainingHashMap<K, V> {
    ...
    private void resizeBackingTable(int length) {
        ...
        // helper array to track tail of each chain in new table so we can append and preserve order
        ExternalChainingMapEntry<K, V>[] tails =
        ...
        for (int i = 0; i < oldTable.length; i++) {
            ...
            while (current != null) {
                ...
                if (newTable[newIndex] == null) {
                    ...
                    tails[newIndex] = newEntry;
                } else {
                    tails[newIndex].setNext(newEntry);
                    tails[newIndex] = newEntry;
                }
                current = current.getNext();
            }
